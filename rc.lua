...
tags = {
    names = { "main", "web", 3, 4, 5, 6, 7, 8, 9 },
    layout = { layouts[1], layouts[9], layouts[1], layouts[1], layouts[1], layouts[1], layouts[1], layouts[1], layouts[1] }
}
